...
function assertSetValidationRules(rules_str, test, cb) {
    exports.setValidationRules(rules_str, function (err) {
        if (err) {
            test.ok(false);
        } else {
            test.ok(true);
...
exports.assertSetValidationRules = assertSetValidationRules;
