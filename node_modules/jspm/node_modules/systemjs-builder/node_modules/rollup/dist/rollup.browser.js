/*
	Rollup.js v0.25.1
	Thu Jan 21 2016 12:35:58 GMT-0500 (EST) - commit c750730d9ba2ba3395e28c1a47dc8c8c27019c67
...
(function (global, factory) {
  ...
  pp$2.isUseStrict = function (stmt) {
  ...
  pp$2.isContextual = function (name) {
    return this.type === tt.name && this.value === name;
  };

  // Consumes contextual keyword if possible.

  pp$2.eatContextual = function (name) {
    return this.value === name && this.eat(tt.name);
  };

  // Asserts that following token is given contextual keyword.

  pp$2.expectContextual = function (name) {
    if (!this.eatContextual(name)) this.unexpected();
  };

  // Test whether a semicolon can be inserted at the current position.

  pp$2.canInsertSemicolon = function () {
    return this.type === tt.eof || this.type === tt.braceR || lineBreak.test(this.input.slice(this.lastTokEnd, this.start));
  };

  pp$2.insertSemicolon = function () {
  ...
  pp$2.semicolon = function () {
    if (!this.eat(tt.semi) && !this.insertSemicolon()) this.unexpected();
  };

  pp$2.afterTrailingComma = function (tokType) {
  ...
  pp$2.expect = function (type) {
    this.eat(type) || this.unexpected();
  };

  // Raise an unexpected token error.

  pp$2.unexpected = function (pos) {
    this.raise(pos != null ? pos : this.start, "Unexpected token");
  };

  pp$2.checkPatternErrors = function (refDestructuringErrors, andThrow) {
    var pos = refDestructuringErrors && refDestructuringErrors.trailingComma;
    if (!andThrow) return !!pos;
    if (pos) this.raise(pos, "Trailing comma is not permitted in destructuring patterns");
  };

  pp$2.checkExpressionErrors = function (refDestructuringErrors, andThrow) {
